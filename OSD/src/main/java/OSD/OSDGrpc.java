...
public final class OSDGrpc {
  ...
  public static final String SERVICE_NAME = "OSD.OSD";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<OSD.FileData,
      OSD.EmptyMessage> getPutFileMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "putFile",
      requestType = OSD.FileData.class,
      responseType = OSD.EmptyMessage.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<OSD.FileData,
      OSD.EmptyMessage> getPutFileMethod() {
    io.grpc.MethodDescriptor<OSD.FileData, OSD.EmptyMessage> getPutFileMethod;
    if ((getPutFileMethod = OSDGrpc.getPutFileMethod) == null) {
      synchronized (OSDGrpc.class) {
        if ((getPutFileMethod = OSDGrpc.getPutFileMethod) == null) {
          OSDGrpc.getPutFileMethod = getPutFileMethod = 
              io.grpc.MethodDescriptor.<OSD.FileData, OSD.EmptyMessage>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "OSD.OSD", "putFile"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  OSD.FileData.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  OSD.EmptyMessage.getDefaultInstance()))
  ...
  public static abstract class OSDImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void putFile(OSD.FileData request,
        io.grpc.stub.StreamObserver<OSD.EmptyMessage> responseObserver) {
  ...
  public static final class OSDBlockingStub extends io.grpc.stub.AbstractStub<OSDBlockingStub> {
    ...
    /**
     */
    public OSD.EmptyMessage putFile(OSD.FileData request) {
  ...
  public static final class OSDFutureStub extends io.grpc.stub.AbstractStub<OSDFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<OSD.EmptyMessage> putFile(
        OSD.FileData request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PUT_FILE:
          serviceImpl.putFile((OSD.FileData) request,
              (io.grpc.stub.StreamObserver<OSD.EmptyMessage>) responseObserver);
          break;
        default:
  ...
  private static abstract class OSDBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return OSD.OSDProto.getDescriptor();
    }
